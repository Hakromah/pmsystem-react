         ...
         <div className="flex justify-between border p-10 rounded-lg ">
            ...
            <ScrollArea className="h-[80vh] w-[60%]">
               <div>
                  ...
                  <div className="py-5">
                     <h2 className="font-semibold text-gray-400">Issue Description
                  ...
                  <div className="mt-5">
                     ...
                     <Tabs defaultValue="comments" className="w-[400px]">
                        ...
                        <TabsContent value="all">
                           All make changes to your account, such as your password or email address.
                        </TabsContent>
                        <TabsContent value="comments">
                           ...
                           <div className="mt-8 space-y-6">
                              {comment.comments?.map((item) =>
                                 <CommentCard itemData={item} key={item} />
                              )}
                           </div>

                        </TabsContent>
                        <TabsContent value="history">
                           History make changes to your account, such as your password or email address.
                        </TabsContent>
                     </Tabs>
                  </div>
               </div>
               ...
               <div className="border rounded-lg">
                  ...
                  <div className="p-5">
                     <div className="space-y-7">
                        ...
                        <div className="flex gap-10 items-center">
                           <p className="w-[7rem]">Reporters</p>
