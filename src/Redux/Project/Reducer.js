import { ACCEPT_INVITATION_REQUEST, CREATE_PROJECTS_REQUEST, CREATE_PROJECTS_SUCCESS, DELETE_PROJECTS_REQUEST, DELETE_PROJECTS_SUCCESS, FETCH_PROJECTS_BY_ID_REQUEST, FETCH_PROJECTS_BY_ID_SUCCESS, FETCH_PROJECTS_REQUEST, FETCH_PROJECTS_SUCCESS, INVITE_PROJECTS_REQUEST, SEARCH_PROJECTS_REQUEST, SEARCH_PROJECTS_SUCCESS } from "./ActionTypes";
...
export const projectReducer = (state = initialState, action) => {
   switch (action.type) {
      ...
      case DELETE_PROJECTS_SUCCESS:
         console.log("DELETE_PROJECTS_SUCCESS ======> ", action.projectId);
