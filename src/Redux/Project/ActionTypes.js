...
export const INVITE_PROJECTS_REQUEST = 'INVITE_PROJECTS_REQUEST';
export const INVITE_PROJECTS_SUCCESS = 'INVITE_PROJECTS_SUCCESS';
export const INVITE_PROJECTS_FAILURE = 'INVITE_PROJECTS_FAILURE';

export const ACCEPT_INVITATION_REQUEST = 'ACCEPT_PROJECTS_REQUEST';
export const ACCEPT_INVITATION_SUCCESS = 'ACCEPT_PROJECTS_SUCCESS';
export const ACCEPT_INVITATION_FAILURE = 'ACCEPT_PROJECTS_FAILURE';
